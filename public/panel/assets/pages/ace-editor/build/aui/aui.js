...
*/
    ...
    var YUI = function() {
            ...
            /**
                ...
                @example
                    ...
                    YUI().use('node', function(Y) {
                        //debug assets used here
                    });

                    YUI({
                        filter: 'min'
                    }).use('node', function(Y) {
                        //min assets used here
                    });
        ...
        if (l) {
            ...
            // overriding values set in those config assets if there is a '
            // matching property.
            for (; i < l; i++) {
            ...
            process = function(names, skip) {
                ...
                YArray.each(names, function(name) {
                    ...
                    if (m) {
                        ...
                        // CSS assets don't register themselves, see if it has
                        // been loaded
 ...
 * minified version of the assets (e.g., event-min.js).  The filter property
...
var ua = Y.UA,
    ...
    // that the css rules in multiple assets could be applied out of order
...
Y.Get = {
     ...
     * (useful when passing in an array of js assets). Receives the same
     * payload as onSuccess, with the addition of a <code>url</code>
     * property, which identifies the file which was loaded.</dd>
     * <dt>async</dt>
     * <dd>
     * <p>When passing in an array of JS assets, setting this flag to true
     ...
     * </dd>
     * <dt>onProgress</dt>
     * <dd>callback to execute when each individual file is done loading (useful when passing in an array of css assets). Receives the same
     ...
     * <dt>async</dt>
     * <dd>When passing in an array of css assets, setting this flag to true will insert them
 ...
 * JS assets.  The build system is supposed to remove log statements
 * from the raw and minified versions of the assets.
 *
 * @method log
 * @for YUI
 ...
 * minified and raw versions of the YUI assets, unlike log statements.
 * @method message
 * @for YUI
 * @param  {String}  msg  The message to log.
 * @param  {String}  cat  The log category for the message.  Default
...
/**
 * Loader dynamically loads script and css assets.  It includes the dependency
 * info for the version of the library in use, and will automatically pull in
 * dependencies for the modules requested.  It supports rollup assets and will
 * automatically use these when appropriate in order to minimize the number of
 * http connections required to load all of the dependencies.  It can load the
 * assets from the Yahoo! CDN, and it can utilize the combo service provided on
...
Y.Loader = function(o) {
    ...
    /**
    * The default seperator to use between assets in a combo URL
    * @property comboSep
    * @type {String}
    * @default Ampersand
    */
    ...
    /**
     * List of rollup assets found in the library metadata
     * @property rollups
     */
    // self.rollups = null;
...
Y.Loader.prototype = {
   ...
   _requires: function(mod1, mod2) {
        ...
        // external css assets should be sorted below yui css
...
// Add rollup file, need to add to supersedes list too
    ...
    */
    _insert: function(source, o, type, skipcalc) {
        ...
        // and any additional assets will need to be loaded
        // individually
