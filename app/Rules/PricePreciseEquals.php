...
class PricePreciseEquals implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        return $decimals <= $this->precise->price_precision;
    }
    ...
    {
        return "The quantity precision should be less than or equals {$this->precise->price_precision}";
    }
}
